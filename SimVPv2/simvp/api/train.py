...
from simvp.core.metrics import eval_metrics
    ...
    def train(self):
        ...
        for epoch in range(self._epoch, self.config['epoch']):
            ...
            if epoch % self.args.log_step == 0:
                ...
                print_log('Epoch: {0}, Steps: {1} | Lr: {2:.7f} | Train Loss(rmse): {3:.7f} | Vali Loss(rmse): {4:.7f}\n'.format(
                    epoch + 1, len(self.train_loader), cur_lr, loss_mean ** (1/2), vali_loss))
